...
<body style="font-family: Verdana;">
	...
	<center>
		<img src="${pageContext.request.contextPath}/Images/jd.jpg"
			width="1400" height="600" alt="Italian Trulli">
	</center>
	...
	<div style="overflow: auto">
		...
		<div class="main">
			<iframe src="${pageContext.request.contextPath}/Images/justDoIt.png"
				height="400" width="350" style="border: none;"></iframe>
		</div>
		<div class="right">
			<h2>What?</h2>
			...
			<li><a href="ModalLogin.jsp">LoginModal</a></li>
		</div>
	</div>
</body>
